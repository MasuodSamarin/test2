...
copy *.mp3 ..\
cd ..
isd_download.exe -tonorflash -dev br17 -boot 0x2000 -div6 -wait 300 -format cfg -f uboot.boot sdram.app bt_cfg.bin fast_run.bin power_off.mp3 music.mp3 linein.mp3 radio.mp3 pc.mp3 wait.mp3 connect.mp3 disconnect.mp3 ring.mp3  F_ASCII_S.PIX F_GB2312.TAB F_GB2312_S.PIX ui_sty.sty menu.res -key AC690X.key
